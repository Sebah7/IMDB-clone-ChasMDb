        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div class="bg-white dark:bg-gray-800 shadow sm:rounded-lg p-6">
                ...
                <form action="/profile/update" method="post">
                    ...
                    <input type="text" id="name" name="name" placeholder="Click here to edit your name" class="block w-full rounded-md border-gray-300 focus:border-blue-400 focus:ring focus:ring-blue-400 focus:ring-opacity-50">

                    <label for="email" class="block mt-4 font-semibold">Email</label>
                    <input type="email" id="email" name="email" placeholder="Click here to edit your email" class="block w-full rounded-md border-gray-300 focus:border-blue-400 focus:ring focus:ring-blue-400 focus:ring-opacity-50">
