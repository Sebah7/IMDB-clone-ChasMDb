...
<body>
    ...
    <header class="bg-red" style="position: fixed; width: 100%; margin-top: 0px; background-color: rgb(246, 236, 255); box-shadow: 2px 2px 20px 2px rgba(137, 43, 226, 0.098);">
        <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global" style="padding: 20px 20px;">
          ...
          <div class="hidden lg:flex lg:gap-x-12">
            <a href="./movies.blade.php" class="text-sm font-semibold leading-6 text-gray-900">Movies</a>
            <a href="./genre.blade.php" class="text-sm font-semibold leading-6 text-gray-900">Genres</a>
            <a href="./userdashboard.blade.php" class="text-sm font-semibold leading-6 text-gray-900">Watchlist</a>
          </div>
    ...
    <div class="userfiltersection" style="display: flex; justify-content: space-between; padding: 10px 20px;" id="movies__">
        <div class="left_____" style="margin-top: 15px;">
            ...
            <a href="#" class="text-sm font-semibold leading-6 text-gray-900" style="font-weight: 600; margin-left: 30px;">Watchlist</a>
            ...
            <style>
                ...
                .left_____ a:hover{
                    background: linear-gradient(to right, rgba(0, 0, 255, 0.251), rgb(141, 100, 255));
                    color: white;
                    padding: 4px 10px;
                    border-radius: 5px;
    ...
    <div class="moviesection">
        ...
        <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-white-800 dark:border-white-700" style="border-style: solid; padding: 0; width: 200px;">
            <a href="#">
                <img class="" src="https://media.istockphoto.com/id/1162194157/sv/vektor/smart-city-emirates-silhuett-i-stil-l%C3%A5g-poly-wireframe-isolerad-p%C3%A5-naken-bakgrund-polygonal.jpg?s=612x612&w=0&k=20&c=QxpYfpxNQaCaHPv_WBSYY-Hkl92kPSjqTFw30Q8pAdY=" alt="movie image" />
            </a>
            <div class="px-5 pb-5">
                <a href="#">
                    <h5 class="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">The Transfomers</h5>
                </a>
