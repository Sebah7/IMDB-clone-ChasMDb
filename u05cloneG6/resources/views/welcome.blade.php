                ...
                <div class="">
                    <div class="p-6 text-gray-900 dark:text-gray-100" style="margin-left:35px;">
                        ...
                        <ul class="flex space-x-4 overflow-x-auto" style="padding: 10px 20px; margin-top:-30px;margin-left:30px; white-space: nowrap; justify-content: space-between; text-aline:center;">
                                ...
                                <a href="/onemovie"><li class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-white-800 dark:border-white-700" style="border-style: solid; padding: 0; width: 200px; height:300px; margin-left:20px; justify-content: space-between;">
                                    <a href="#">
                                    ...
                                    <div class="px-5 pb-5">
                                        ...
                                        <div class="flex items-center justify-between">
                                            <a href="#" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add to Watchlist</a>
                                        </div>
                                    </div>
                                </li>
                                                    </a>
